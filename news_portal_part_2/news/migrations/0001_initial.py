# Generated by Django 5.0 on 2023-12-05 08:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choose_news', models.CharField(choices=[('AR', 'Статья'), ('NE', 'Новости')], max_length=2)),
                ('datetime_post', models.DateTimeField(auto_now_add=True)),
                ('title', models.CharField(default='Заголовок статьи/новости', max_length=255)),
